...
discussions-to: https://github.com/ethereum/EIPs/issues/1646
status: Draft
...
## Abstract
This protocol allows any user, developer, organization to register ,backup and update their zero-identities by running smart contracts. It can protect the user's crytoassets held by smart contracts and social media account when the private key lost, and it can effectively eliminate theft and fraud from hackers and malicious smart contracts.
This protocol is a fundamental protocol for the blockchain‘s decentralized autonomous civilization.
...
## Implementation
The reference implementation for ERC-1646 may be found in [Silkroad-Framework/eip](https://github.com/Silkroad-Framework/eip).
